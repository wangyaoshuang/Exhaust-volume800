	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
       ...
       System.out.println("1");
        ...
        if(0==this.parenturlNum){                                //当parenturl为空时执行
        	...
        	if(servleturl.contains("/generatecheckcode") || servleturl.contains("index.jsp") || servleturl.contains("/css") || servleturl.contains("/js") || servleturl.contains("/images") || servleturl.contains("/welcome")){    
        		chain.doFilter(request, response);                 //略过公共页面
        	}
