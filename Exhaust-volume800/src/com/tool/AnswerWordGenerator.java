...
public class AnswerWordGenerator {
	 private static Configuration configuration = null;  
	    ...
	    static {  
	        ...
	        configuration.setClassForTemplateLoading(AnswerWordGenerator.class, "/com/lovo/ftl");  
	        allTemplates = new HashMap<>();   // Java 7 钻石语法  
	        try {  
	            allTemplates.put("resume", configuration.getTemplate("answer_resume.ftl","utf-8"));  
	        } catch (IOException e) {  
	            e.printStackTrace();  
