...
public class QuestionService {
	...
	public int addQuestion(String content, int chapter, int type, int level, String answer, String a, String b,
			...
			int p=questionDao.addQuestion(content, chapter, type, level, answer, a, b, c, d,description,t_id,o_id,o_time);
			return p;
	}
	...
	@Transactional(readOnly = false)
	public int updateQuestion(int q, String content, int chapter, int type, int level, String answer,String t_description,
			int t_id,int o_id,String o_time) {
		
		int a = questionDao.updateQuestion(q, content, chapter, type, level, answer,t_description,t_id,o_id,o_time);
		return a;
	}
	@Transactional(readOnly = false)
	public int updateQuestion(int q, String content, int chapter, int type, int level, String answer, String a,
			String b, String c, String d,String t_description,int t_id,int o_id,String o_time) {
		int p = questionDao.updateQuestion(q, content, chapter, type, level, answer, a, b, c, d,t_description,t_id,o_id,o_time);
		return p; 
	}
