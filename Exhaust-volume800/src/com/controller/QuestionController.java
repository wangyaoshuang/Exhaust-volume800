...
public class QuestionController {
	...
	public String addQuestionImp(HttpServletRequest request) {
		...
		int p=questionService.addQuestion(content, chapter, type, level, answer, A, B, C, D, t_description, t_id, o_id,o_time);
	...
	public String updateQuestion(HttpServletRequest request) {
		...
		int a = questionService.updateQuestion(q_id, content, chapter, type, level, answer, t_description, t_id, o_id, o_time);
		request.setAttribute("msg", a);
		return "forward:/question/findQuestionByChapter/" + schapter;
	}
	...
	public String updateChooseQuestion(HttpServletRequest request) {
		...
		int a = questionService.updateQuestion(q_id, content, chapter, type, level, answer, A, B, C, D, t_description, t_id,
				o_id, o_time);
		request.setAttribute("msg", a);
		return "forward:/question/findQuestionByChapter/" + schapter;
	}
