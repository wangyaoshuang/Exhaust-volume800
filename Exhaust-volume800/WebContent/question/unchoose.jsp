...
<script type="text/javascript">
 ...
 function show1(){
	...
	var submitUnchooseValue = submitUnchoose[0].action+"?description="+description_fu[0].value+"&teacher_id=${teacher.id}";
	submitUnchoose[0].action = submitUnchooseValue;
  	window.submitUnchoose.submit();
 }
</script>
</head>
<body>
	...
	<table class="table table-hover">
		<form action="${ctx}/question/addUnChoose" method=post name="submitUnchoose">
			<table>
				...
				<tr height="80">
					<td>答案：</td>
					<td><textarea class="editor_id" name="answer" style="width:120%;height:150px;visibility:hidden;"></textarea> </td>
				</tr>
				<tr height="80">
