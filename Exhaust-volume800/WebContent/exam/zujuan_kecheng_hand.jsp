...
<link href="${ctx }/css/zujuan_kecheng.css" rel="stylesheet"
	type="text/css">
</head>
<body>
	...
	<div class="m-b-md">
		<h3 class="m-b-none">
			<a href="${ctx }/question/preview">组卷系统</a>
		</h3>
		<small>Welcome back, ${teacher.name }</small>
	</div>
	<section class="panel panel-default">
	<div class="choose">请选择课程：</div>
	...
	</c:forEach> </section> </section> </section> </section> </section> </section> <script src="${ctx }/js/app.v2.js"></script> <!-- Bootstrap -->
	<!-- App --> <script
		src="${ctx }/js/charts/easypiechart/jquery.easy-pie-chart.js"
